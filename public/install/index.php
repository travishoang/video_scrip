            ...
            case "2": ?>
              ...
              if($_POST && isset($_POST["dbscs"])){
                ...
                <center>
                  ...
                  <br>
				  <a target="_blank" href="https://vnvip.pro/video-streaming-portal-ma-nguon-website-truc-tuyen-video-phim-tv-show">Bản miễn phí VNvip.Pro</a>
				  <br>
                  <p>Tài khoản mặc định là: <strong>admin@admin.com</strong> và mật khẩu mặc định: <strong>admin</strong></p><br><strong>
                  <p><a class='button is-link' href='../admin'>Login</a></p></strong>
                  <br>
                  <p class='help has-text-grey'>Anh em có thể thêm Master admin trong users và xóa admin mặc định đi nhé</p>
                </center>
                <?php
              }else{ ?>
                <div class='notification is-danger'>Sorry, something went wrong.</div><?php
